        ...
        <div className="dashboard-content">
            <div className="landing h-[75vh] lg:h-[85vh] flex flex-col justify-center items-center">
                ...
                <div className="subtext px-[3rem] md:px-0 text-lg md:text-xl lg:text-4xl text-center mt-6">
                    <p>Bringing transparency, efficiency, and fairness to relief distribution.</p>
                    <p> Every transaction is secure, verifiable, and accountable.</p>
                </div>
            ...
            <div className="status bg-cblack w-full h-[600px] mt-[6rem] text-cwhite px-[3rem]">
