        ...
        <div className="user-management-wrapper px-6 pt-6">
            <div className="header flex justify-between items-center w-full">
                ...
                <div className="right flex items-center space-x-4">
                    <button className='px-6 py-2 text-base bg-clgreen hover:bg-cgreen rounded-lg ctransition' onClick={() => setIsRegisterClicked(true)}>Register Admin</button>
                    <div className="search flex">
                        <input type="text" id="search" className='border-none outline-none w-[300px] rounded-l-md focus-within:outline focus-within:ring-clgreen'/>
            ...
            <div className='admins rounded-xl overflow-hidden w-full mt-6'>
                <table className='w-full text-base text-left'>
                    <thead className='text-gray-700 uppercase bg-clgreen'>
                        <tr>
                    ...
                    <tbody>
                        {admins && admins.map((admin, index) => {
                            return (<tr key={index} class={`${index % 2 == 0 ? 'bg-gray-50' : 'bg-cwhite'} border-b border-gray-200 text-cblack`}>
                                <td class="px-6 py-4">
                                    {admin.id}
                                </td>
                                <td class="px-6 py-4">
