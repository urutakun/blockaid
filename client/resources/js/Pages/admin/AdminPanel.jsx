            ...
            <div className="beneficiaries">
                <div className="table-wrapper mt-4">
                    <div className="header flex justify-between items-center">
                        <p className='text-3xl font-bold text-gray-500'>Beneficiaries</p>
                    ...
                    <div className="table rounded-xl overflow-hidden w-full mt-6">
                        <table className='w-full text-base text-left'>
                            ...
                            <tbody>
                                    {beneficiaries.map((beneficiary, index) => {
                                        ...
                                        return (<tr class={`${index % 2 == 0 ? 'bg-gray-50' : 'bg-cwhite'} border-b border-gray-200 text-cblack`}>
                                            <td class="px-6 py-4">
                                                {beneficiary.id}
                                            </td>
